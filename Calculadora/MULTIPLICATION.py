...
first_number.send_keys('66')
second_number = driver.find_element_by_css_selector('[ng-model="second"]')
second_number.send_keys('5')

#erformed
operation_add = UI.Select(driver.find_element_by_css_selector('[ng-model=operator]')).select_by_value("MULTIPLICATION")
